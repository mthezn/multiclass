...
class InstrumentDatasetTest(Dataset):
    def __init__(self, image_dirs, gt_dirs, transform=None, class_to_id=None):
        """
        image_dirs: lista di cartelle con i frame RGB
        gt_dirs: lista di cartelle 'ground_truth' (una per dataset)
        """
        ...
        self.class_colors = {
            ...
            7: np.array((255, 0, 0))  # vessel sealer = rosso
    ...
    def __getitem__(self, idx):
        ...
        is_instrument_dataset_7 = "instrument_dataset_7" in img_path
        if img_name in self.mask_paths:
            ...
            for id_color, color in self.class_colors.items():
                ...
                if is_instrument_dataset_1 or is_instrument_dataset_7:
